...
$text['stavhlaseni'] = 'stav hlášení';
$text['hlasenineniprirazenopripadu'] = 'hlášení není přiřazeno k žádnému případu.';
...
$text['posledniuprava'] = 'Poslední úprava';
$text['spojenospripady'] = 'Spojeno s případy';
$text['shrnuti'] = 'Shrnutí';
$text['moznedopady'] = 'Možné dopady';
$text['podrobnyprubeh'] = 'Podrobný průběh';
$text['energetickanarocnost'] = 'Energetická náročnost';
$text['uvodnivstupy'] = 'Úvodní vstupy';
