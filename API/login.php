...
#TODO failsafe count number of failed login attempts in a period of time and if higher, deny servise
...
if (isset($_GET['username']) and isset($_GET['password'])) { 
	...
	if($userresult=mysqli_fetch_array ($usersql)) {
        # mazani identickych sessionID	mysqli_query ($database,"UPDATE ".DB_PREFIX."users set sid='' where sid='".session_id()."'");
