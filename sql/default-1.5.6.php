...
PRIMARY KEY(`id`),
FULLTEXT (`title`), FULLTEXT (`contents`)
) ENGINE=MyISAM COLLATE=utf8_general_ci;
...
PRIMARY KEY(`id`),
FULLTEXT (`name`), FULLTEXT (`surname`), FULLTEXT (`contents`)
) ENGINE=MyISAM COLLATE=utf8_general_ci;
...
PRIMARY KEY(`id`),
FULLTEXT (`label`), FULLTEXT (`task`), FULLTEXT (`summary`), FULLTEXT (`impacts`), FULLTEXT (`details`)
) ENGINE=MyISAM COLLATE=utf8_general_ci;
