...
$columnAlter['user']['right_text'] = " rightTextOld int(3) NOT NULL DEFAULT '0' after aclHunt ";
$columnAlter['user']['right_power'] = " rightPowerOld int(3) NOT NULL DEFAULT '0' after aclHunt ";
$columnAlter['user']['right_org'] = " rightOrgOld int(3) NOT NULL DEFAULT '0' after aclHunt ";
$columnAlter['user']['right_aud'] = " rightAudOld int(3) NOT NULL DEFAULT '0' after aclHunt ";
$columnAlter['user']['right_super'] = " rightSuperOld int(3) NOT NULL DEFAULT '0' after aclHunt ";
...
if ($counterColumnAdd + $counterColumnAlter + $counterColumnMarkdown + $counterFulltextAdd + $counterPasswordEncrypt + $counterTableRename + $counterTableDrop + $counterTableCreate + $counterIndexAdd + $counterUPdateRight> 0) {
