...
- refactor: index.php restructured #220
...
- refactor: storing platform configuration #82
- refactor: installer update #107

**1.8.5**
- refactor: upgrade procesure #213
- style: recover icon #191
- style: unread icon #187
- refactor: menu on mobile #190
