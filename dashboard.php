...
$latteParameters['unfinishedreports'] = mysqli_num_rows ($unfinishedreports_count);
if (mysqli_num_rows ($unfinishedreports_count)) {
...
$latteParameters['unfinishedcases'] = mysqli_num_rows ($unfinishedcases_count);
if (mysqli_num_rows ($unfinishedcases_count)) {
...
$latteParameters['unfinishedtasks'] = mysqli_num_rows ($unfinishedtasks_count);
if (mysqli_num_rows ($unfinishedtasks_count)) {
